...
// // here the argument can be any type and the return type can also be any type

// let fun1 : Function = (a:number , b:number) =>{
//     return true;
// }
// console.log(fun1(4,6));


// // here the argument and the return type should be same type where we have specified after arrow

// let fun1 : (arg1 : number, arg2 : number) => number = (arg1, arg2) =>{
//     return arg1+arg2;
// }
...
// let fun1 : (arg1 : number, arg2 : string) => number = (arg1, arg2) =>{
//     return arg1+arg2;
// }
// console.log(fun1(5,"dfj"));


// // we can use less parameters than declared

// let fun1 : (arg1 : number, arg2 : number) => number = (arg1) =>{
//     return arg1;
// }
// console.log(fun1(5,4));


// // but we can't use extra parameters than declared

// let fun1 : (arg1 : number, arg2 : number) => number = (arg1,arg2,arg3) =>{
//     return arg1+arg2;
// }
// console.log(fun1(5,4));
