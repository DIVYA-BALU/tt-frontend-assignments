...
import { StatusMessage, SubscriptionPlan, SubscriptionTransaction } from '../models/models';
...
export class PaymentService {
  ...
  getPlANS() {
    return this.http.get<SubscriptionPlan[]>(`${environment.baseUrl}subscription-plans`);
  }
