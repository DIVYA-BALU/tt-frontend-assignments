...
export class AddPostComponent {
  ...
  constructor( public dialogRef: MatDialogRef<AddPostComponent>,
    @Inject(MAT_DIALOG_DATA) public id:string,private formBuilder:FormBuilder, private petPostService:PetPostService, ){}
  ...
  request() {
    ...
    this.petPostService.savePetPost(formData).subscribe({next : (res) => {
      console.log(res);
